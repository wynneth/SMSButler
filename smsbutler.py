...
logging.basicConfig(format='%(asctime)s:%(levelname)s:%(module)s.%(funcName)s.%(threadName)s:%(message)s', filename="/var/log/smsbutler",level=logging.DEBUG)
...
while (True):
  ...
  except (ResponseNotReady, ServerNotFound, HttpLib2Error):
